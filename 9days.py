#LINEAR REGRESSION
#REGRESSION ML PYTHON
#CREATE TEST FILE AND ADD IN THIS PROGRAM 
...
pred = regr.predict(x)
plt.plot(x,np.array(pred).reshape(-1,1),color="red")
#plt.plot(x,pred,color="red")
error = y-pred
for r in range(0,len(x)):
    print("%10.3f\t%10.3f%10.3f"%(y[r],pred[r],error[r]))
plt.show()    
